...
<body id="main">
    ...
    <script>
        if (!localStorage.getItem('alumnifa:cookiesconsent')) {
            snackbar.destroyAllSnackbars()
            snackbar.createSnackbar('En poursuivant votre navigation sur ce site, vous acceptez l’utilisation des cookies.', {
                position: 'left',
                actions: [
                    {
                        text: 'Accepter',
                        callback(button, snackbar) {
                            localStorage.setItem('alumnifa:cookiesconsent', true)
                            snackbar.destroy()
                        }
                    }
                ]
